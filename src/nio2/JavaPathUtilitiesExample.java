...
public class JavaPathUtilitiesExample {
	
	public static void main(String[] args) {
		
        Path path1 = Paths.get("/usr/home/pooja");
        ...
        // subpath
        System.out.println(path1.subpath(0, 3)); // usr\home\pooja
        System.out.println(path1.subpath(1, 2)); // home
        System.out.println(path1.subpath(1, 3)); // home\pooja
